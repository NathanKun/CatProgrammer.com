...
<head>
    ...
    <link rel="stylesheet" href="css/tempHumiChart.css">
</head>
...
<body>
    <div class='row'>
        ...
        <div id='list' class='col'>
            ...
            <p><a id='GetAll' href='tempHumiChart.php?all=true'>Get all</a></p>
        </div>
    </div>
    ...
    <script>
        ...
        window.onload = function() {
            // show after loading, so that browser repaint chart div, else css's flex display will be override ?
            $('#tempHumiChart').hide();
            loadData();
        ...
        function changeData(index) {
            ...
            window.myChart.options.title['text'] = 'tempHumiChart : ' + finalList.DateList[index];
                ...
                Papa.parse(result, {
                    ...
                    complete: function(result) {
                        ...
                        options = {
                            ...
                            title: {
                                display: true,
                                text: 'tempHumiChart : ' + finalList.DataList[finalList.DataList.length - 1].Date
                            },
                            tooltips: {
                                mode: 'index',
                                intersect: false,
